...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final UserAdapter.ViewHolder viewHolder, int i) {
        ...
        //on visiting our profile
        viewHolder.btn_follow.setVisibility(View.VISIBLE);
        viewHolder.username.setText(user.getUsersname());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public Button btn_follow; //FOLLOW
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            btn_follow =itemView.findViewById(R.id.btn_follow); //FOLLOW
