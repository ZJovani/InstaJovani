package com.example.instajovani.Adapter;
...
import com.example.instajovani.Activities.CommentsActivity;
import com.example.instajovani.Fragment.PostDetailFragment;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ImageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final PostAdapter.ImageViewHolder holder, final int position) {
        ...
        Glide.with(mContext).load(post.getPostimage())
                .apply(new RequestOptions().placeholder(R.drawable.profileplaceholder))
